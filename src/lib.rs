...
#[derive(Debug)]
pub struct PairBridgeProcessor {
    verbose: bool,
    processed_count: usize,
}

impl PairBridgeProcessor {
...
pub fn run(verbose: bool, input: Option<String>, output: Option<String>) -> Result<()> {
    ...
    info!("Starting PairBridge processing");
    
    let mut processor = PairBridgeProcessor::new(verbose);
...
mod tests {
    ...
    fn test_processor_creation() {
        let processor = PairBridgeProcessor::new(true);
    ...
    fn test_data_processing() {
        let mut processor = PairBridgeProcessor::new(false);
